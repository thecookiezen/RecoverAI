package com.thecookiezen.agenticmemory;
...
import com.thecookiezen.agenticmemory.domain.EvolutionDecision;
import com.thecookiezen.agenticmemory.domain.NeighborUpdate;
import com.thecookiezen.agenticmemory.domain.NoteAnalysis;
...
public class AgenticMemoryAgent {
    ...
    private MemoryNote applyEvolution(MemoryNote note, EvolutionDecision decision) {
        var links = decision.suggestedLinks().stream()
            .map(id -> new NoteLink(id, "related"))
            .toList();
